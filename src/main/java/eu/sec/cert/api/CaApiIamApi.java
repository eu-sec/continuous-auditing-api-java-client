...
public class CaApiIamApi {
     ...
     * @param scope Scope of the service (required)
     * @param from from date in ISO-8601 format (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserAccessesCall(String userId, String scope, String from, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUserAccessesValidateBeforeCall(String userId, String scope, String from, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserAccessesCall(userId, scope, from, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public LoginResponse getUserAccesses(String userId, String scope, String from, Integer limit) throws ApiException {
        ApiResponse<LoginResponse> resp = getUserAccessesWithHttpInfo(userId, scope, from, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LoginResponse> getUserAccessesWithHttpInfo(String userId, String scope, String from, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getUserAccessesValidateBeforeCall(userId, scope, from, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserAccessesAsync(String userId, String scope, String from, Integer limit, final ApiCallback<LoginResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserAccessesValidateBeforeCall(userId, scope, from, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LoginResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
