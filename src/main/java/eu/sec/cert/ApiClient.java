...
import eu.sec.cert.auth.Authentication;
import eu.sec.cert.auth.HttpBasicAuth;
import eu.sec.cert.auth.ApiKeyAuth;
import eu.sec.cert.auth.OAuth;

public class ApiClient {

    private String basePath = "https://localhost/euseccaapi";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/1.0.8/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost/euseccaapi
